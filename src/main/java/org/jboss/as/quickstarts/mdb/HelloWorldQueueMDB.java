 ...
 */
@ResourceAdapter("activemq-ra-ConnectionFactorySimulatorPooled")
/*@JMSDestinationDefinitions(
        value = {
                @JMSDestinationDefinition(
                        name = "java:jboss/exported/jms/queue/HELLOWORLDMDBQueue",
                        interfaceName = "javax.jms.Queue",
                        destinationName = "HelloWorldMDBQueue"
                ),
                @JMSDestinationDefinition(
                        name = "java:jboss/exported/jms/topic/HELLOWORLDMDBTopic",
