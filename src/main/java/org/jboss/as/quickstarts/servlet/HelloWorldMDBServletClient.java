...
public class HelloWorldMDBServletClient extends HttpServlet {
    ...
    @Inject
    @JMSConnectionFactory("java:jboss/ConnectionFactorySimulator")
    private JMSContext context;

    @Resource(lookup = "java:/jms/queue/HELLOWORLDMDBQueue")
    private Queue queue;

    @Resource(lookup = "java:/jms/topic/HELLOWORLDMDBTopic")
    private Topic topic;
